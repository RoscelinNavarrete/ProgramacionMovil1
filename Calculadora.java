...
public class Calculadora extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle b) {
        ...
        pantalla.setFocusable(false); // evita que el teclado virtual aparezca
